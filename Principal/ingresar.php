		...
		<h1 id="fh5co-logo"><a href="index.php"><img src="../images/logo.png" alt="Fruits&Veggies"></a></h1>
			<nav id="fh5co-main-menu" role="navigation">
				<ul>
					...
					<li class="fh5co-active"><a href="ingresar.php">Ingresar</a></li>
				</ul>
			</nav>
		...
		<div id="fh5co-main">
			<div class="fh5co-narrow-content animate-box" data-animate-effect="fadeInLeft">	
				<form action="login.php" method="post">
					<div class="col-md-6">
						<a href="#">
							<img src="https://cdn.pixabay.com/photo/2018/11/13/22/01/instagram-3814081__340.png" alt="LOGIN" class="img-responsive">
						</a>
					</div>
					<div class="col-md-6">
						<div class="col-md-4">
						...
						<div class="form-group">
							<input type="text" class="form-control" placeholder="ID" id="id" name="idusuario">
						</div>
						<div class="form-group">
							<input type="password" class="form-control" placeholder="Password" id ="pwd" name="pwdusuario">
						</div>
						<div class="form-group">
							Empleado 
							<input type="checkbox" class="btn btn-primary btn-md" value="empleados" id="empleado" name="tipousuario">
						</div>
					<div class="form-group">
